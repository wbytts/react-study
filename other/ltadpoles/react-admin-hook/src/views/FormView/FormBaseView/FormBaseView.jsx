            ...
            <Form {...formItemLayout} onSubmit={handleSubmit}>
              ...
              <Form.Item label="邮箱">
                {getFieldDecorator('email', {
                  ...
                  <AutoComplete dataSource={websiteOptions} onChange={handleWebsiteChange} placeholder="请输入邮箱">
                    <Input />
                  </AutoComplete>,
                )}
              </Form.Item>
              ...
              <Form.Item label="确认密码" hasFeedback>
                {getFieldDecorator('confirm', {
                  ...
                  <Input.Password
                    onBlur={e => setConfirmDirty(() => (confirmDirty ? confirmDirty : !!e.target.value))}
                    placeholder="请确认密码"
                  />,
                )}
              </Form.Item>
