...
class FromView extends Component {
  ...
  render() {
    ...
    const websiteOptions = this.state.autoCompleteResult.map(website => <AutoCompleteOption key={website}>{website}</AutoCompleteOption>);
      ...
      <Layout className="animated fadeIn">
        ...
        <Row>
          <Col>
            <div className="base-style">
              <div>
                {this.state.visible ? <Alert message="你最好认真的填写表单!" type="warning" closable banner afterClose={this.handleClose} /> : null}
              </div>
              <Divider orientation="left">基础功能123</Divider>
              <Form {...formItemLayout} onSubmit={this.handleSubmit}>
                ...
                <Form.Item label="邮箱">
                  {getFieldDecorator('email', {
                    ...
                    <AutoComplete dataSource={websiteOptions} onChange={this.handleWebsiteChange} placeholder="请输入邮箱">
                      <Input />
                    </AutoComplete>,
                  )}
                </Form.Item>
