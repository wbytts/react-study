...
const FormStepView2 = loadable(() => import(/* webpackChunkName: 'formStep2' */ '@/views/FormView/FormStepView2'));
...
const Demo001 = loadable(() => import(/* webpackChunkName: 'about' */ '@/views/Demo/001'));
...
const routes = [
  ...
  { path: '/form/step-form2', exact: false, name: '表单', component: FormStepView2 },
  ...
  { path: '/demo/001', exact: false, name: 'demo-001', component: Demo001, auth: [1] },
];
